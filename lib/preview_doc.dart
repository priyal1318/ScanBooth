...
class PagesPreviewWidgetState extends State<PagesPreviewWidget> {
              ...
              FlatButton(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Container(width: 4,color: Colors.indigo),
                    Text('More',
                        style: TextStyle(inherit: true, color: Colors.white)),
                  ],
                ),
        ...
        builder: (BuildContext bc) {
          return Container(
            child: new Wrap(
              children: <Widget>[
                ListTile(
                  leading: new Icon(Icons.text_fields, color: Colors.indigo),
                ...
                ListTile(
                  leading: new Icon(Icons.picture_as_pdf,color: Colors.indigo),
                ...
                ListTile(
                  leading: new Icon(Icons.image, color: Colors.indigo),
                ...
                ListTile(
                  leading: new Icon(Icons.close,color: Colors.indigo),
        ...
        builder: (BuildContext bc) {
          return Container(
            child: new Wrap(
              children: <Widget>[
                ListTile(
                  leading: new Icon(Icons.scanner,color: Colors.indigo),
                ...
                ListTile(
                  leading: new Icon(Icons.photo_size_select_actual,color: Colors.indigo),
  ...
  Future<bool> checkHasPages(BuildContext context) async {
    ...
    await showAlertDialog(context, 'Some pages require action', title: 'Info');
    return false;
  }
